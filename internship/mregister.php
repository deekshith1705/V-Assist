							...
							<div class="col-md-6 col-md-offset-1">
								<div class="map-container">
									<form action="mregister1.php" method="post" class="contact-form">
										...
										<span> (Name should start with a capital letter)</span><br> 	 <br>
										...
										<input type="text" id="pin" name="pin" placeholder="Pincode" onblur="validpin()">
										<span id="t14"></span> <br>
...
var p= new RegExp("^[5000][0-9]{2}");
 if(p.test(pi))
{
  document.getElementById("t14").style="color:green";
 document.getElementById("t14").innerHTML="Valid pin";
 document.getElementById("address").disabled=false;
}
else
{
 document.getElementById("t14").style="color:red";
document.getElementById("t14").innerHTML="Invalid pin please enter a valid pincode";
}
}
